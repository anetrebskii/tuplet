...
export const tailCommand: CommandHandler = {
  ...
  help: {
    ...
    examples: [
      { command: 'tail /ctx/log.txt', description: 'Show last 10 lines' },
      { command: 'tail -n 3 /ctx/history.json', description: 'Show last 3 lines' },
      { command: 'cat /ctx/data | tail -n 5', description: 'Last 5 lines of piped input' }
    ],
    notes: [
